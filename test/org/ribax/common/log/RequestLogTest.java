...
public class RequestLogTest {
    ...
    /**
     * Test of getInstance method, of class RequestLog.
     */
    @Test
    public void testGetInstance() {
        System.out.println("getInstance");

        RequestLog result = RequestLog.getInstance(WebDataSource.class.getName());
    ...
    public void testGetInstanceWithComponent() {
        ...
        RequestLog result = RequestLog.getInstance(WebDataSource.class.getName(), panel);
        assertNotNull(result);
    }
}
